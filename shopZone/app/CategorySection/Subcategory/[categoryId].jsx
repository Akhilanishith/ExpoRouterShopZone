...
//             renderItem={({ item }) => (
//               <TouchableOpacity
//                 onPress={() => handleClick(item._id)} // Navigate on click
...
//             productType={selectedSubtype} // Pass the selected subtype as the productType
//           />
//         )}
//       </View>
//     </>
...
//   chevronIcon: { marginRight: 8 }, // Adds spacing between the icon and text
...
//   subcategoryImage: { width: 80, height: 80, borderRadius: 40 },
//   subcategoryText: { marginTop: 5, fontSize: 14, fontWeight: 'bold' },
// });
