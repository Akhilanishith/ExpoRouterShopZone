        ...
        <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ flexGrow: 1, padding: '20px' }}>
                    <h1 style={{ fontSize: '24px', marginBottom: '20px' }}>Seller Verification</h1>

                    {/* Pending Sellers Table */}
                    <h2 style={{ fontSize: '20px', marginBottom: '10px' }}>Pending Sellers</h2>
                    ...
                    <h2 style={{ fontSize: '20px', marginBottom: '10px' }}>Verified Sellers</h2>
